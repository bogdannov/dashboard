    ...
    <div class="row">
        <div class="col-md-6 js_graphic-parent">
            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">Tittle Graphics</h3>
                ...
                <div class="box-body">
                    <div class="chart">
                        <canvas class="js_graphic-default" width="500px" height="200" style="width: 500px; height: 200px;"></canvas>
        ...
        <div class="col-md-6 js_graphic-parent">
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <div class="chart">
                        <canvas class="js_graphic-without-point-grid" width="500px" height="200" style="width: 500px; height: 200px;"></canvas>
                        <a href="#" class="text-light-blue pull-right js_graphic-change" style="padding: 3px 0;">Change of view</a>
                    </div>
        ...
        <div class="col-md-6 js_graphic-parent">
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <div class="chart">
                        <canvas class="js_graphic-bar" width="500px" height="200" style="width: 500px; height: 200px;"></canvas>
                        <a href="#" class="text-light-blue pull-right js_graphic-change" style="padding: 3px 0;">Change of view</a>
        ...
        <div class="col-md-6 js_graphic-parent">
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <div class="chart">
                        <canvas class="js_graphic-default2" width="500px" height="200" style="width: 500px; height: 200px;"></canvas>
                        <a href="#" class="text-light-blue pull-right js_graphic-change" style="padding: 3px 0;">Change of view</a>
                    </div>
                </div>
                <!-- /.box-body -->
