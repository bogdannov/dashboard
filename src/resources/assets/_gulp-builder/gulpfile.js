...
var main_project_path = 'public_html';
...
var path = {
    ...
    src: {
        ...
        zip: [settings.build_dir + '/**', '!' + settings.build_dir + '/_gulp-builder/node_modules/**', '!' + settings.build_dir + '/_gulp-builder/bower_components/**'],
    },
    watch: {
        css: src_dir + '/sass/**/*.*',
        img: src_dir + '/img/**/*.*',
