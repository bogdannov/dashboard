...
use Webmagic\Dashboard\Traits\Content\FieldNotValidException;
use Webmagic\Dashboard\Traits\Content\FieldUnavailable;
use Webmagic\Dashboard\Traits\Content\NoOneFieldsWereDefined;
use Webmagic\Dashboard\Traits\Content\UnacceptableValueException;
...
class ContentFieldUsableTest extends TestCase
{
     ...
     * @throws \Exception
     * @throws \Webmagic\Dashboard\Traits\Content\ContentTypeException
     * @throws \Webmagic\Dashboard\Traits\Content\FieldNotDefined
     *
     * @group test
     */
